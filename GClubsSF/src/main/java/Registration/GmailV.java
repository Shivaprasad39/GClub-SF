...
public class GmailV {
	...
	/** Application name. */
    private static final String APPLICATION_NAME = "GClubs";
    ...
    private static final String CREDENTIALS_FILE_PATH = System.getProperty("user.dir") +
            ...
            File.separator + "resources" +
            File.separator + "Credential" +
            File.separator + "credential.json.json";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GmailV.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
